                            ...
                            <div className="testimonial__items d-flex align-items-center">
                                ...
                                <div className="testimonial__items--content">
                                    ...
                                    <p className="testimonial__items--desc">
                                        Lorem ipsum dolor sit, amet consectetur is adipisicing elit.
                                        Recusandae iusto veritatis eveniet, amet sint are suscipit!
                                    </p>
                                    ...
                                    <div className="testimonial__chat--icon">
                                        ...
                                        >
                                            <path
                                                ...
                                                transform="translate(-62.5 -118.975)"
                                                fill="currentColor"
                                                opacity="0.11"
                                            />
                                        </svg>
                        ...
                        <div className="swiper-slide">
                            <div className="blog__items">
                                <div className="blog__items--thumbnail">
                                    <a className="blog__items--link" href="blog-details.html">
                                        <img
                                ...
                                <div className="blog__items--content">
                                    <div className="blog__items--meta">
                                        <ul className="d-flex">
                                            <li className="blog__items--meta__list">
                                                <svg
                                                    className="blog__items--meta__icon"
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    width={15}
                                                    height={15}
                                                    viewBox="0 0 15 15"
                                    ...
                                    <h3 className="blog__items--title">
                                        <a href="blog-details.html">
                                            Aypi Non Habent Claritatemnon Insitam
                                        </a>
                                    </h3>
                                    <p className="blog__items--desc">
                                        It is a long established fact that a reader will be by the
                                        readable content of a page when looking at.{" "}
                                    </p>
                                    <a className="blog__items--readmore" href="blog-details.html">
                                        Read more{" "}
                                        <svg
                                            className="blog__items--readmore__icon"
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="6.2"
                                            height="6.2"
                                            viewBox="0 0 6.2 6.2"
                        ...
                        <div className="swiper-slide">
                            <div className="blog__items">
                                ...
                                <div className="blog__items--content">
                                    ...
                                    <h3 className="blog__items--title">
                                        <a href="blog-details.html">
                                            Lorem ipsum dolor sit amet are consecte.
                                        </a>
                                    </h3>
                                    <p className="blog__items--desc">
                                        It is a long established fact that a reader will be by the
                        ...
                        <div className="swiper-slide">
                            <div className="blog__items">
                                ...
                                <div className="blog__items--content">
                                    ...
                                    <h3 className="blog__items--title">
                                        <a href="blog-details.html">
                                            Ratione nobis the are delectus in impedit?
                                        </a>
                                    </h3>
                                    <p className="blog__items--desc">
                                        It is a long established fact that a reader will be by the
                    ...
                    <div className="col-lg-5 col-md-5 deals__baner--col">
                        <div className="deals__banner--content">
                            ...
                            <p className="deals__banner--content__desc">
                                Shop our selection of organic fresh vegetables in a discounted
                                price. 10% off on all vegetables.
                            </p>
                            <div
                                className="deals__banner--countdown d-flex"
                                data-countdown="Sep 30, 2022 00:00:00"
                            />
                            <a className="btn deals__banner--content__btn" href="shop.html">
                                Discover Now
                            </a>
                        </div>
                    </div>
                            ...
                            <div className="product__items">
                                ...
                                <div className="product__items--content text-center">
                                    ...
                                    <h3 className="product__items--content__title style2 h4">
                                        <a href="product-details.html">Raw-onions-surface</a>
                                    </h3>
                                    ...
                                    <div className="product__items--sold__stocks d-flex justify-content-between">
                                        <span className="product__items--sold__stocks--text">
                                            Total Sold : 1
                                        </span>
                                        <span className="product__items--sold__stocks--text">
                                            Stocks : 35
                        ...
                        <div className="swiper-slide">
                            <div className="product__items">
                                ...
                                <div className="product__items--content text-center">
                                    ...
                                    <h3 className="product__items--content__title style2 h4">
                                        <a href="product-details.html">Papaya-green</a>
                                    </h3>
                                    <div className="product__items--price">
                        ...
                        <div className="swiper-slide">
                            <div className="product__items ">
                                ...
                                <div className="product__items--content text-center">
                                    ...
                                    <h3 className="product__items--content__title style2 h4">
                                        <a href="product-details.html">Vegetable-healthy</a>
                                    </h3>
                                    <div className="product__items--price">
                        ...
                        <div className="swiper-slide">
                            <div className="product__items">
                                ...
                                <div className="product__items--content text-center">
                                    ...
                                    <h3 className="product__items--content__title style2 h4">
                                        <a href="product-details.html">Fresh-whole-fish</a>
                                    </h3>
                                    <div className="product__items--price">
                        ...
                        <div className="banner__items position__relative">
                            ...
                            >
                                ...
                                <div className="banner__items--content">
                                    <h2 className="banner__items--content__title text__secondary">
                                        Organic Juice
                                    </h2>
        ...
        <section className="product__section section--padding pt-0">
            <div className="container">
                ...
                <ul className="product__tab--one product__tab--btn d-flex justify-content-center mb-35">
                    <li
                        className="product__tab--btn__list active"
                        data-toggle="tab"
                    ...
                    <li
                        className="product__tab--btn__list"
                        data-toggle="tab"
                        data-target="#product_fresh"
                    >
                        Fresh
                    </li>
                    <li
                                ...
                                <div className="col mb-28">
                                    <div className="product__items">
                                        ...
                                        <div className="product__items--content text-center">
                                            ...
                                            <h3 className="product__items--content__title h4">
                                                <a href="product-details.html">Chili-pepper</a>
                                            </h3>
                                            <div className="product__items--price">
                                                <span className="current__price">$38.00</span>
                                                <span className="old__price">$44.00</span>
                                ...
                                <div className="col mb-28">
                                    <div className="product__items">
                                        ...
                                        <div className="product__items--content text-center">
                                            ...
                                            <h3 className="product__items--content__title h4">
                                                <a href="product-details.html">Red-tomato-isolated</a>
                                            </h3>
                                            <div className="product__items--price">
...
function HottestCategoriesList() {
    return (
        <React.Fragment>
                        ...
                        <div className="swiper-wrapper">
                            <div className="swiper-slide">
                                <div className="product__items product__bg">
                                    <div className="product__items--thumbnail">
                                        <a className="product__items--link" href="shop.html">
                                            <img
                                                className="product__items--img"
                                                src="assets/img/product/categories1.png"
                                                alt="categories-img"
                                            />
                                            <div className="product__categories--content d-flex justify-content-between align-items-center">
                                                <div className="product__categories--content__left">
                                                    <h3 className="product__categories--content__maintitle">
                                                        Raw-steak
                                                    </h3>
                                                    <span className="product__categories--content__subtitle">
                                                        99 items
                                                    </span>
                                                </div>
                                ...
                                <div className="product__items product__bg">
                                    <div className="product__items--thumbnail">
                                        <a className="product__items--link" href="shop.html">
                                            <img
                                                className="product__items--img"
                                                src="assets/img/product/categories2.png"
                                                alt="categories-img"
                                            />
                                            <div className="product__categories--content d-flex justify-content-between align-items-center">
                                                <div className="product__categories--content__left">
                                ...
                                <div className="product__items product__bg">
                                    <div className="product__items--thumbnail">
                                        <a className="product__items--link" href="shop.html">
                                            <img
                                                className="product__items--img"
                                                src="assets/img/product/categories3.png"
                                                alt="categories-img"
                                            />
                                            <div className="product__categories--content d-flex justify-content-between align-items-center">
                                                <div className="product__categories--content__left">
                                ...
                                <div className="product__items product__bg">
                                    <div className="product__items--thumbnail">
                                        <a className="product__items--link" href="shop.html">
                                            <img
                                                className="product__items--img"
                                                src="assets/img/product/categories4.png"
                                                alt="categories-img"
                                            />
                                            <div className="product__categories--content d-flex justify-content-between align-items-center">
                                                <div className="product__categories--content__left">
                                    ...
                                    <div className="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center">
                                        <div className="col">
                                            <div className="slider__content slider__content--padding__left">
                                                <span className="slider__content--subtitle text__secondary">Eat clean and
                                                    green</span>
                                                <h2 className="slider__content--maintitle h1">Natural is <span
                                                    className="text__secondary">always</span> <br />
                                                    Healthy</h2>
                                                <p className="slider__content--desc">The more you love your health, more you
                                                    eat organic. No medicine can heal you better than organic food does
                                                </p>
                                                <a className="btn slider__btn" href="shop.html">Shop Now</a>
                                            </div>
                                        </div>
                                        <div className="col">
                                            <div className="hero__slider--layer">
                                                <img className="slider__layer--img "
                                    ...
                                    <div className="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center">
                                        ...
                                        <div className="col">
                                            <div className="hero__slider--layer home1__slider--layer2">
                                                <img className="slider__layer--img  home1__slider--layer2__img"
