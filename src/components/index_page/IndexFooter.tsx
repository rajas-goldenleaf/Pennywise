    ...
    return (
        <footer className="footer__section footer__bg">
                        ...
                        <div className="col-lg-3 footer__col--width col-md-7 footer__col--padding footer__col--order">
                            <div className="footer__widget">
                                ...
                                <div className="footer__widget--inner">
                                    <a className="footer__widget--logo" href="index.html">
                                    ...
                                    <ul className="footer__widget--social d-flex">
                                        <li className="footer__widget--social__list">
                                            <a
                                                className="footer__widget--social__icon"
                                                target="_blank"
            ...
            <img
                ...
                src="assets/img/other/footer-shape1.png"
                alt="footer-shape"
            />
            <img
                className="footer__position--shape__two"
                src="assets/img/other/footer-shape2.png"
                alt="footer-shape"
            />
