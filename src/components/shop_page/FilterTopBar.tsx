...
type FilterTopBarType = {
    changeView: (view: ProductViewType) => void,
    currentView: ProductViewType

}
export default function FilterTopBar({ changeView, currentView }: FilterTopBarType) {
    return (
            ...
            <div className="product__view--mode d-flex align-items-center">
                ...
                <div className="product__view--mode__list">
                    <div className="product__tab--one product__grid--column__buttons d-flex justify-content-center">
                        <button
                            className={`product__grid--column__buttons--icons ${currentView == "grid_view" ? "active" : ""}`}
                            aria-label="grid btn"
                            data-toggle="tab"
                        ...
                        <button
                            className={`product__grid--column__buttons--icons ${currentView == "list_view" ? "active" : ""}`}
                            aria-label="list btn"
                            data-toggle="tab"
