        ...
        <React.Fragment >
            <div style={{ minHeight: "100vh" }}>
                <main className="main__content_wrapper">
                    <Breadcrumb title='About Us' menuItem={["Home", "About Us"]} />
                    <AboutBody />
                    <TeamMembers />
                    <AvailableBrands />
                </main>
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div className="team__items text-center">
                                <div className="team__thumb">
                                    <img
                                        className="team__thumb--img display-block"
                                        src="assets/img/other/team1.png"
                                        alt="team img"
                                    />
                                </div>
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div className="team__items text-center">
                                <div className="team__thumb">
                                    <img
                                        className="team__thumb--img display-block"
                                        src="assets/img/other/team2.png"
                                        alt="team img"
                                    />
                                </div>
                                <div className="team__content">
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div className="team__items text-center">
                                <div className="team__thumb">
                                    <img
                                        className="team__thumb--img display-block"
                                        src="assets/img/other/team3.png"
                                        alt="team img"
                                    />
                                </div>
                                <div className="team__content">
                        ...
                        <div className="about__thumb d-flex">
                            <div className="about__thumb--items">
                                <img
                                    ...
                                    src="assets/img/other/about-thumb-list1.png"
                                    alt="about-thumb"
                                />
                            </div>
